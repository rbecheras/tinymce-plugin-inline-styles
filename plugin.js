...
tinymce.PluginManager.add('inlinestyles', function(editor) {
	...
	// editor.on('GetContent', inlinifyOnEvent);

	editor.on('BeforeSetContent', function(evt){
		console.info('BeforeSetContent');
		console.log(evt);
		console.log(evt.source_view,!allreadyLoaded);
		if (evt.source_view || !allreadyLoaded) {
			allreadyLoaded=true;
			console.log(evt.content);
			inlinifyOnEvent(evt);
			console.log(evt.content);
		}
		// alert('BeforeSetContent');
